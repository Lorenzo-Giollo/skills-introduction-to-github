...
L’aumento della spesa implica che il Servizio Sanitario Nazionale (SSN) con le sue diramazioni regionali (SSR), non sia in grado di rispondere alle domande di cura in maniera appropriata. Questo porta a un aumento della spesa out of pocket per chi può permetterselo, o l’abbandono della cura per la fascia di popolazione incapiente.

Il problema quindi è solo economico ma anche di accesso e qualità delle cure e di utilizzo corretto delle risorse. 

L’uso di soluzioni informatiche (IT e anche ICT) permette la continuità e la personalizzazione delle cure, maggiore accesso e praticità, la riduzione di errori e sprechi, il miglioramento dell'accuratezza diagnostica, il supporto decisionale ai medici, facilita trattamenti e cure al di fuori dell'ambiente clinico, facilita l’empowerment del paziente. 
...
* __Invecchiamento della popolazione__: Man mano che la popolazione invecchia [^2], aumenta la domanda di servizi sanitari. Gli anziani, in media, utilizzano più risorse sanitarie e hanno bisogni di salute più complessi. Con l’età aumenta l’incidenza delle malattie croniche e spesso la presenza di comorbidità che complicano il quadro.

* __Malattie croniche__: La prevalenza di condizioni croniche come il diabete, le malattie cardiache e l'obesità è in aumento. Queste malattie richiedono cure a lungo termine, intensive e costose, e rappresentano una parte significativa dei costi sanitari. [^3] 

* __Organizzazione dei servizi__: Il SSN si trova ad affrontare la sfida di passare da un modello incentrato sulla cura della malattia acuta a uno focalizzato sulla __gestione e prevenzione__ delle cronicità. Ciò implica il potenziamento dei __servizi territoriali e dell'assistenza domiciliare__.
...
* **Costi del lavoro**: Il settore sanitario è ad alta intensità di manodopera e una carenza di personale qualificato (ad es. medici, infermieri) o squilibri di domanda/offerta possono far aumentare i salari (come anche auspicato nel PP relativo al tema), il che a sua volta aumenta i costi operativi per ospedali e altre strutture.
...
* Il modello __"Fee-for-Service"__ (rimborso per prestazione) remunera le strutture sanitarie e i professionisti in base a un tariffario per ogni singolo servizio erogato, come visite o esami. Questo sistema, applicato in Italia principalmente per prestazioni specialistiche e diagnostiche, può incentivare l'erogazione di un maggior numero di servizi per incrementare i guadagni, potenzialmente portando a costi più alti e trattamenti non strettamente necessari. E’ un tema attualmente non centrale, ma che potrebbe diventarlo se si decidesse di orientarsi verso un modello di sanità misto pubblico-privato.
...
* __Sprechi, frodi e abusi__: Una quantità significativa di spesa sanitaria (20%) viene persa ogni anno a causa di pratiche inefficienti, richieste fraudolente e abusi [^4].
...
* Finora non si sono impiegate le tecnologie digitali al massimo delle loro potenzialità. Si tratta non solo si una questione tecnologica, ma un vero e proprio cambiamento di paradigma, che dovrebbe anche potenziare una starndardizzazione nazionale almeno delle principali soluzioni adottate. Questa posizione è fondamentale perché affronta molte delle sfide che il Servizio Sanitario Nazionale italiano (SSN) deve affrontare. Il SSN che è di tipo universalistico, è sotto pressione a causa dell'invecchiamento della popolazione, dell'aumento delle malattie croniche e delle disparità regionali. La sanità digitale offre soluzioni concrete a queste problematiche per modernizzare il sistema e garantire un'assistenza equa e sostenibile.
  
* L’uso di sistemi di SD permette il __contenimento dei costi__, il controllo della appropriatezza, la riduzione/eliminazione degli sprechi, la migliore organizzazione dei flussi di lavoro e del pieno impiego delle infrastrutture, l’eliminazione di errori (ad es. di trascrizione) migliore esiti delle cure.
...
## Proposta
1. [Attribuzione delle funzioni di regia, controllo e monitoraggio](#1-Governance-e-Coordinamento-Centralizzato-oltre-le-disparità-regionali)
...
* Analisi e ricerca: Facilita l'analisi di grandi set di dati per la ricerca medica, l'epidemiologia e la medicina predittiva. Si possono facilmente aggregare dati per identificare tendenze o rischi per la salute.
* Supporto decisionale clinico: I sistemi possono utilizzare questi dati per generare avvisi, promemoria o raccomandazioni cliniche automatiche, migliorando la qualità delle cure.
* Efficienza: Riduce gli errori di inserimento dati e accelera i processi clinici e amministrativi (incluso il controllo dei costi).
* Integrazione dell'IA: I dati strutturati sono essenziali per addestrare algoritmi di intelligenza artificiale e apprendimento automatico per diagnosi, previsioni e gestione delle cure.

Sebbene sia importante, per ottenere il massimo risultato, digitalizzare tutti i processi, la priorità deve essere data ad alcuni strumenti, i due principali rappresentano l’infrastruttura portante su cui innestare gli altri applicativi: la **Cartella Clinica Elettronica (CCE) e il Fascicolo Sanitario Elettronico (FSE)**. 
A questi due principali software, vera ossatura del sistema informativo sanitario, possono affiancarsi i software __CUP__ (Centri Unici di Prenotazione) e i sistema di __Business Intelligence__ e __Data Analytics__. I primi sostengono l'accesso dei cittadini/pazienti al sistema sanitario (pubblico e privato intra moenia); i secondi aiutano a monitorare l'apporpriatezza (in senso esteso).

*In appendice al presente PP si fornisce una panoramica dei principali software, al fine di evidenziare le potenzialità in termini di raccolta dei dati, quindi monitoraggio e conseguenti effetti positivi su costi, impiego delle risorse, continuità e qualità delle cure.*

La Cartella Clinica Elettronica (CCE) e il Fascicolo Sanitario Elettronico (FSE) rappresentano i software prioritari per la digitalizzazione della sanità, perché sono l’ossatura e il cuore pulsante delle informazioni cliniche. La CCE è lo strumento operativo quotidiano dei professionisti sanitari all’interno di una singola struttura (ospedale o clinica): integra la storia clinica del paziente, diagnosi, esami di laboratorio, terapie e note mediche, automatizzando processi altrimenti manuali e ottimizzando il flusso di lavoro. Il FSE, invece, funge da repository centralizzato e sicuro dei dati sanitari del cittadino, accessibile non solo da diversi specialisti e strutture sanitarie a livello nazionale ed europeo [^8], ma anche dallo stesso paziente, che può arricchirlo tramite il taccuino personale. **L’interoperabilità tra questi due strumenti migliora la continuità delle cure, riduce gli sprechi e limita gli errori dovuti alla mancanza di informazioni. L’adozione congiunta di CCE e FSE crea così un ecosistema digitale coerente, capace di rafforzare l’efficienza amministrativa, ottimizzare la gestione delle risorse e garantire un’assistenza più sicura, personalizzata e tempestiva**. In sostanza, costituiscono i mattoni fondamentali su cui costruire un sistema sanitario moderno e integrato.

I dati attuali mostrano un uso tutto sommato diffuso del FSE da parte dei medici (MMG e PLS 95%, medici specialisti delle ASL 72%) e dei cittadini (21%), con diverse intensità tra regioni [^10].
Rimangono problemi di disomogeneità e di interoperabilità ai quali il PNRR sta cercando di porre rimedio. Bisogna verificare che effettivamente il c.d. FSE 2.0 raggiunga gli obiettivi proposti.
...
Altri software che portano efficienza e possono aiutare a ridurre le disparità regionali, affianca e si interfaccia con il FSE, comnprende i software per l'accesso alle cure, come quelli utilizzati dai **CUP** (Centri Unici di Prenotazione): sono sistemi informativi complessi, progettati per gestire in modo centralizzato e integrato la domanda e l'offerta di prestazioni sanitarie. Hanno la funzione di centralizzare le prenotazioni (visite, esami e prestazioni); ottimizzare le risorse (verifica in tempo reale della disponibilità di medici, sale d'esame e attrezzature specialistiche, prevenendo sovrapposizioni e massimizzando l'uso di ogni risorsa); ridurre le liste d'attesa attraverso la distribuzione del carico di lavoro tra i vari professionisti e le strutture basandosi su criteri di priorità [^12]. Devono prevedere la possibilità di gestire le prenotazioni attraverso diversi canali (sportello fisico, telefono, online e app). Anche qui l'AI può giocare un ruolo importamnte, per il pieno utilizzo delle risorse (ad es. strumentazione diagnostica RM, TAC, ecc) e la gestione delle liste d'attesa con prioritarizzazione dei pazienti in base a set di informazioni come il profilo clinico/anagrafico e l'urgenza.

Infine gli strumenti di __Business Intelligece__ (BI) e __Data Analytics__ (DA), completano il quadro per un set minimo perché integrano le informazioni e restituiscono, organizzandole in _dashboard_, le informazioni per aumentare l'efficienza del sistema. 
* La __BI__ serve alla gestione clinica,ospedaliera e amministrativa, raggruppando informazioni sui tempi di attesa, l'utilizzo delle risorse (ad es. quanti letti sono occupati in ogni dato momento?), costi (es. costo medio per paziente per tipologia di intervento), personale e performance, flusso di pazienti, performance de: Quante visite ha effettuato un medico? Qual è il tasso di successo di un certo trattamento?
...
* __Teleconsulto__: Si tratta di una consultazione tra due o più professionisti sanitari (ad esempio, un medico di base che chiede il parere di uno specialista), spesso per discutere casi complessi o per ottenere una seconda opinione. Può avvenire in tempo reale o in modalità "store-and-forward", dove i dati vengono inviati e analizzati in un secondo momento.
...
La digitalizzazione automatizza le attività amministrative e di routine, come la gestione delle cartelle cliniche, la prenotazione degli appuntamenti e la prescrizione di farmaci. Questo permette ai professionisti sanitari di ridurre il carico burocratico e di dedicare più tempo a ciò che conta davvero: l'interazione diretta con il paziente e la diagnosi clinica [^19].

"L'informatica può ridurre il tasso di errori medici nelle pratiche sanitarie, creando e supportando vari effetti. Migliora la comunicazione, rende la conoscenza più accessibile, richiede informazioni chiave, aiuta con i calcoli, esegue controlli in tempo reale, assiste il monitoraggio e fornisce supporto alle decisioni. Può migliorare significativamente la sicurezza dell'assistenza medica strutturando le azioni, intercettando gli errori e portando un supporto decisionale basato sull'evidenza e centrato sul paziente direttamente nel punto di cura" [^20].
...
* I software per l'accesso alle cure, come quelli utilizzati dai CUP (Centri Unici di Prenotazione), descritti nel PP (supra) per la prenotazione, disdetta e gestione delle liste d'attesa per le prestazioni sanitarie.
...
[^8]: Regolamento (UE) 2025/327 del Parlamento Europeo e del Consiglio dell’11 febbraio 2025 sullo spazio europeo dei dati sanitari e che modifica la direttiva 2011/24/UE e il regolamento (UE) 2024/2847
https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202500327 

[^9]: Per ottenere il massimo risultato dall’uso di strumenti informatici, il dato deve essere strutturato. Un **dato strutturato** in sanità digitale è un'informazione organizzata e standardizzata secondo un formato predefinito e fisso. Questa organizzazione permette ai sistemi informatici di ricercare, elaborare e analizzare automaticamente le informazioni. Solitamente i dati anagrafici e amministrativi, parametri vitali, farmaci e terapie, codici medici, referti di laboratorio. Questo è in netto contrasto con i dati non strutturati (ad esempio, il testo libero di una cartella clinica), che sono più difficili da interpretare per le macchine. E’ però vero che le tecniche avanzate di elaborazione del linguaggio naturale (NLP), un ramo dell'AI, permettono di analizzare e comprendere il significato del testo scritto in linguaggio naturale. L'applicazione di queste tecniche consente di trasformare i dati non strutturati in dati strutturati.

[^10]: Dati al 31 marzo 2025, si considera il numero di accessi/uso nei 90 giorni precedenti alla data di rilevamento. Questi i valori rilevati: percentuale di MMG/PLS che hanno effettuato almeno una operazione su FSE; percentuale di medici specialisti che sono abilitati al FSE;  percentuale dei cittadini assistiti che hanno effettuato almeno un accesso al proprio FSE (~4.9 mln) rispetto al totale degli assistiti per i quali è stato messo a disposizione almeno un documento cittadini per cui è stato pubblicato un documento (~23.6 mln).  https://www.fascicolosanitario.gov.it/monitoraggio 

[^11]: Perché i FSE regionali presentano contenuti e servizi differenti. Ad esempio, alcune regioni caricano automaticamente solo i referti di esami e visite specialistiche, mentre altre includono anche il "profilo sanitario sintetico" redatto dal medico di base, le lettere di dimissione ospedaliera o i dati sulle vaccinazioni. Problemi di accesso da parte del personale di diverse regioni, o peggio in alcuni casi persino in diverse ASL della stessa regione. Su questo e sulla % d'uso della CCE si veda https://www.osservatori.net/comunicato/sanita-digitale/sanita-digitale-spesa-italia/

[^12]: Codici RAO - Raggruppamenti di Attesa Omogenea - https://www.agenas.gov.it/comunicazione/primo-piano/1798-manuale-rao-per-l%E2%80%99accesso-alle-prestazioni-specialistiche-ambulatoriali 

[^13]:Si può incorrere spesso in problemi di definizione e differenze tra ___telemedicina___ (di solito ci si riferisce all'uso della tecnologia per lo scambio di informazioni cliniche, all’infrastruttura tecnologica), ___telehealth___(che include comunicazioni sincrone e asincrone) e ___virtual care___ (che rappresenta l’intera esperienza di cura fornita a distanza). Ai fini del presente documento si utilizza il termine più comune telemedicina, ma si intende l’adozione più ampia possibile di tecnologia e servizi ai fini di risolvere i problemi di gestione di molte patologie per incidere positivamente sui costi e sulla qualità di vita dei pazienti. https://www.ama-assn.org/practice-management/digital-health/what-telehealth e https://www.elationhealth.com/resources/blogs/virtual-care-vs-telehealth-understanding-the-distinctions 

[^14]: A differenza dei farmaci tradizionali, dove il principio attivo è una molecola chimica, nelle terapie digitali il "principio attivo" è l'algoritmo che eroga l'intervento terapeutico. Per dimostrare che questo algoritmo funziona e produce gli effetti desiderati, è necessario condurre studi clinici. Un esempio è reSET® https://www.news-medical.net/news/20170914/FDA-permits-first-digital-therapeutic-device-for-treatment-of-substance-use-disorders.aspx 
...
[^16]: L’AI Act (Regolamento (UE) 2024/1689) classifica le soluzioni di intelligenza artificiale (AI) in base al __livello di rischio che comportano per gli interessi pubblici, i diritti fondamentali e la sicurezza degli individui__. I servizi e le applicazioni/soluzioni impiegate e/o offerte dovranno rispettare la normativa nazionale ed europea in materia seguendo le indicazioni riportate nella ISO/IEC 23894:2023, standard per la gestione dei rischi specificamente correlati all’ Intelligenza Artificiale applicate con riferimento all’AI Act ed essere sviluppate in accordo alle Linee Guida “linee guida per l’adozione di IA nella pubblica amministrazione” pubblicate da AgID e successive modificazioni. Le suddette soluzioni devono essere progettate per ridurre al minimo i rischi per la sicurezza, la privacy e i diritti degli individui, garantendo al contempo l'affidabilità, la trasparenza, la giustizia ed essere in grado di rispondere prontamente ai cambiamenti del contesto normativo e tecnologico fornendo sistemi di monitoraggio e audit per consentire la verifica del rispetto delle norme e dei principi e delle modalità di utilizzo dei dati. L'etica nelle soluzioni di intelligenza artificiale (AI) è un tema cruciale e multidimensionale, che riguarda la progettazione, lo sviluppo, l'implementazione e l'uso delle tecnologie AI in modo che rispettino i valori morali e i diritti umani. I servizi e le applicazioni/soluzioni impiegate e/o offerte dovranno, pertanto, applicare i principi di responsabilità, accessibilità, inclusività, non discriminazione, trasparenza e informazione delle modalità di utilizzo delle informazioni seguendo gli Orientamenti etici per un’IA affidabile (AI HLEG) ed essere governati seguendo questi principi. Orientamenti etici per un'AI affidabile https://op.europa.eu/en/publication-detail/-/publication/d3988569-0434-11ea-8c1f-01aa75ed71a1/language-it 

[^17]: Esistono diverse ragioni, sia legali che pratiche, per cui un attacco informatico nel settore sanitario potrebbe non essere divulgato: le normative sulla privacy (come il GDPR in Europa e l'HIPAA negli Stati Uniti) impongono la notifica pubblica solo in caso di violazione di dati sensibili dei pazienti. Se un attacco, come un attacco DDoS che blocca i servizi o un malware che viene neutralizzato prima di compromettere i dati, non comporta il furto di informazioni personali, non vi è un obbligo di notifica pubblica. Altre ragioni per la sottorappresentazione, possono dipendere dal _danno Reputazionale_, le organizzazioni sanitarie, come gli ospedali, si basano sulla fiducia dei pazienti e eivelare di essere stati vittima di un attacco cyber può minare questa fiducia causando un grave danno d'immagine, ma anche una _minore visibilità delle piccole strutture_ e una minore presenza sui canali d'informazione.

[^18]: https://www.agendadigitale.eu/sanita/sanita-digitale-cosa-non-funziona-le-priorita-per-non-sprecare-gli-investimenti/

[^19]: Conti, A.; Gonella, S.; Berardinelli, D.; Dimonte, V.; Campagna, S. "Time spent on activities that can be delegated and reasons for not delegating among acute care nurses: A mixed‐methods study" in JOURNAL OF ADVANCED NURSING https://iris.unito.it/bitstream/2318/1997591/3/Time%20spent%20on%20activities_post-print.pdf 

[^20]: Jayesh Bhatt Information technology to reduce medical errors: An overview. https://www.researchgate.net/publication/270220055_Information_technology_to_reduce_medical_errors_An_overview 

[^21]: MEF, Dipartimento della Ragioneria generale dello Stato, Studi e pubblicazioni, "Le tendenze di medio-lungo periodo del sistema pensionistico e socio-sanitario. Rapporto n. 25 - Nota di aggiornamento", 2024.
