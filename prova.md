...
La **digitalizzazione è uno strumento abilitante**, introduce nuove tecnologie e le utilizza per facilitare e migliorare i processi, le cure e la gestione del sistema sanitario. La digitalizzazione può (e dovrebbe) coinvolgere praticamente ogni ambito della sanità. Sebbene sia importante digitalizzare tutti i processi, la priorità deve essere data ai due strumenti che rappresentano l’infrastruttura portante su cui innestare gli altri applicativi: la **Cartella Clinica Elettronica (CCE) e il Fascicolo Sanitario Elettronico (FSE)**. 
...
L'efficienza del sistema dipende da strumenti digitali solidi e interoperabili [^9]. 
