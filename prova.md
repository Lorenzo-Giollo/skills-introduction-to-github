...
L’aumento della spesa implica che il Servizio Sanitario Nazionale (SSN) con le sue diramazioni regionali, non sia in grado di rispondere alle domande di cura in maniera appropriata. Questo porta a un aumento della spesa out of pocket per chi può permetterselo, o l’abbandono della cura per la fascia di popolazione incapiente.

Il problema quindi non è solo economico ma anche di accesso e qualità delle cure e di utilizzo corretto delle risorse. 

L’uso di software permette la continuità e la personalizzazione delle cure, maggiore accesso e praticità, la riduzione di errori e sprechi, il miglioramento dell'accuratezza diagnostica, il supporto decisionale ai medici, facilita trattamenti e cure al di fuori dell'ambiente clinico, facilita l’empowerment del paziente. 
...
___ELABORARE ____ A questi due principali possono affiancarsi i sw per i CUP e i sistema di Business Intelligence e Data Analytics.
